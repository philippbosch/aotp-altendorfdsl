    ...
    if form:
        ...
        if request.method == 'POST':
            ...
            if form_instance.is_valid():
                ...
                html = t.render(c)
                msg = EmailMultiAlternatives(mailtext.title, decode_htmlentities(strip_tags(html)), 'Initiative Schnelles Internet Altendorf-Ersdorf <bitte.nicht.antworten@dsl-altendorf-ersdorf.de>', [supporter.email])
